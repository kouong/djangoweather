...
def home(request):
	...
	if request.method == "POST":
		...
		api_request = requests.get("https://www.airnowapi.org/aq/observation/zipCode/current/?format=application/json&zipCode="+ zipcode +"&distance=5&API_KEY=F7BF97A8-9E90-43D8-B8F0-02CE40E3AC00")
		...
		if api[0]['Category']['Name'] == "Good":
			...
			category_description = "(251 - 300) Health warnings of emergency conditions. The entire population is more likely to be affected."
